...
class LevelsControllerTest < ActionController::TestCase
  ...
  test "should create level" do
    assert_difference('Level.count') do
      post :create, level: { answer: @level.answer, hint: @level.hint, link: @level.link, question: @level.question }
    end
  ...
  test "should update level" do
    patch :update, id: @level, level: { answer: @level.answer, hint: @level.hint, link: @level.link, question: @level.question }
    assert_redirected_to level_path(assigns(:level))
  end
